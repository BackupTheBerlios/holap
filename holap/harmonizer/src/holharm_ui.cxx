...
Fl_Double_Window* holharm_ui::make_window() {
  { ui_win = new Fl_Double_Window(390, 322, gettext("holharm"));
    ...
    { Rueda* o = D_Wet = new Rueda(10, 44, 50, 60, gettext("Wet/Dry"));
      D_Wet->box(FL_FLAT_BOX);
      D_Wet->color((Fl_Color)147);
      D_Wet->selection_color(FL_INACTIVE_COLOR);
      D_Wet->labeltype(FL_NORMAL_LABEL);
      D_Wet->labelfont(0);
      D_Wet->labelsize(11);
      D_Wet->labelcolor(FL_BACKGROUND2_COLOR);
      D_Wet->step(0.01);
    ...
    { Rueda* o = D_Pan = new Rueda(150, 44, 50, 60, gettext("Pan"));
      ...
      D_Pan->selection_color(FL_INACTIVE_COLOR);
      D_Pan->labeltype(FL_NORMAL_LABEL);
      D_Pan->labelfont(0);
      D_Pan->labelsize(11);
      D_Pan->labelcolor(FL_BACKGROUND2_COLOR);
      D_Pan->step(0.01);
      D_Pan->value(0.5);
    ...
    { Rueda* o = D_IntR = new Rueda(80, 139, 50, 60, gettext("Interval R"));
      ...
      D_IntR->selection_color(FL_INACTIVE_COLOR);
      D_IntR->labeltype(FL_NORMAL_LABEL);
      D_IntR->labelfont(0);
      D_IntR->labelsize(11);
      D_IntR->labelcolor(FL_BACKGROUND2_COLOR);
      D_IntR->minimum(-12);
      D_IntR->maximum(12);
      D_IntR->step(1);
    ...
    { Rueda* o = D_IntL = new Rueda(10, 139, 50, 60, gettext("Interval L"));
      ...
      D_IntL->selection_color(FL_INACTIVE_COLOR);
      D_IntL->labeltype(FL_NORMAL_LABEL);
      D_IntL->labelfont(0);
      D_IntL->labelsize(11);
      D_IntL->labelcolor(FL_BACKGROUND2_COLOR);
      D_IntL->minimum(-12);
      D_IntL->maximum(12);
      D_IntL->step(1);
    ...
    { Rueda* o = D_IntRL = new Rueda(150, 139, 50, 60, gettext("Interval L+R"));
      ...
      D_IntRL->selection_color(FL_INACTIVE_COLOR);
      D_IntRL->labeltype(FL_NORMAL_LABEL);
      D_IntRL->labelfont(0);
      D_IntRL->labelsize(11);
      D_IntRL->labelcolor(FL_BACKGROUND2_COLOR);
      D_IntRL->minimum(-12);
      D_IntRL->maximum(12);
      D_IntRL->step(1);
    ...
    { Quality = new Fl_Group(225, 90, 155, 30, gettext("Quality"));
      ...
      Quality->labelcolor(FL_BACKGROUND2_COLOR);
      { q4 = new Fl_Check_Button(230, 95, 40, 20, gettext("Poor"));
        q4->type(102);
        q4->down_box(FL_DOWN_BOX);
        q4->labelsize(10);
        q4->labelcolor(FL_BACKGROUND2_COLOR);
      ...
      { q8 = new Fl_Check_Button(280, 95, 45, 20, gettext("Fine"));
        ...
        q8->labelsize(10);
        q8->labelcolor(FL_BACKGROUND2_COLOR);
      ...
      { q16 = new Fl_Check_Button(330, 95, 40, 20, gettext("Good"));
        ...
        q16->labelsize(10);
        q16->labelcolor(FL_BACKGROUND2_COLOR);
    ...
    { D_Type = new Fl_Choice(130, 220, 90, 20, gettext("Mode"));
      ...
      D_Type->labelsize(11);
      D_Type->labelcolor(FL_BACKGROUND2_COLOR);
      D_Type->textsize(11);
    ...
    { D_Note = new Fl_Choice(130, 255, 90, 20, gettext("Base"));
      ...
      D_Note->labelsize(11);
      D_Note->labelcolor(FL_BACKGROUND2_COLOR);
      D_Note->textsize(11);
    ...
    { D_ChType = new Fl_Choice(130, 285, 90, 20, gettext("Chord"));
      ...
      D_ChType->labelcolor(FL_BACKGROUND2_COLOR);
