...
Fl_Double_Window* holharm_ui::make_window() {
  { ui_win = new Fl_Double_Window(470, 360, gettext("exciter"));
    ...
    { Rueda* o = D_Dry = new Rueda(10, 44, 50, 60, gettext("Dry"));
      ...
      D_Dry->selection_color(FL_INACTIVE_COLOR);
      D_Dry->labeltype(FL_NORMAL_LABEL);
      D_Dry->labelfont(0);
      D_Dry->labelsize(11);
      D_Dry->labelcolor(FL_BACKGROUND2_COLOR);
      D_Dry->step(0.01);
    ...
    { Rueda* o = D_Freq = new Rueda(220, 44, 50, 60, gettext("Filter Freq"));
      ...
      D_Freq->selection_color(FL_INACTIVE_COLOR);
      D_Freq->labeltype(FL_NORMAL_LABEL);
      D_Freq->labelfont(0);
      D_Freq->labelsize(11);
      D_Freq->labelcolor(FL_BACKGROUND2_COLOR);
      D_Freq->minimum(21);
    ...
    { D_Mag1 = new SliderW(15, 144, 26, 181, gettext("Har.1"));
      ...
      D_Mag1->labelfont(0);
      D_Mag1->labelsize(11);
      D_Mag1->labelcolor(FL_BACKGROUND2_COLOR);
      D_Mag1->minimum(1);
      D_Mag1->maximum(-1);
      D_Mag1->step(0.01);
    ...
    { D_Mag2 = new SliderW(60, 144, 26, 181, gettext("Har.2"));
      ...
      D_Mag2->labelfont(0);
      D_Mag2->labelsize(11);
      D_Mag2->labelcolor(FL_BACKGROUND2_COLOR);
      D_Mag2->minimum(1);
      D_Mag2->maximum(-1);
      D_Mag2->step(0.01);
    ...
    { D_Mag3 = new SliderW(105, 144, 26, 181, gettext("Har.3"));
      ...
      D_Mag3->labelfont(0);
      D_Mag3->labelsize(11);
      D_Mag3->labelcolor(FL_BACKGROUND2_COLOR);
      D_Mag3->minimum(1);
      D_Mag3->maximum(-1);
      D_Mag3->step(0.01);
    ...
    { D_Mag4 = new SliderW(150, 144, 26, 181, gettext("Har.4"));
      ...
      D_Mag4->labelfont(0);
      D_Mag4->labelsize(11);
      D_Mag4->labelcolor(FL_BACKGROUND2_COLOR);
      D_Mag4->minimum(1);
      D_Mag4->maximum(-1);
      D_Mag4->step(0.01);
    ...
    { D_Mag5 = new SliderW(195, 144, 26, 181, gettext("Har.5"));
      ...
      D_Mag5->labelfont(0);
      D_Mag5->labelsize(11);
      D_Mag5->labelcolor(FL_BACKGROUND2_COLOR);
      D_Mag5->minimum(1);
      D_Mag5->maximum(-1);
      D_Mag5->step(0.01);
    ...
    { D_Mag6 = new SliderW(240, 144, 26, 181, gettext("Har.6"));
      ...
      D_Mag6->labelfont(0);
      D_Mag6->labelsize(11);
      D_Mag6->labelcolor(FL_BACKGROUND2_COLOR);
      D_Mag6->minimum(1);
      D_Mag6->maximum(-1);
      D_Mag6->step(0.01);
    ...
    { D_Mag7 = new SliderW(285, 144, 26, 181, gettext("Har.7"));
      ...
      D_Mag7->labelfont(0);
      D_Mag7->labelsize(11);
      D_Mag7->labelcolor(FL_BACKGROUND2_COLOR);
      D_Mag7->minimum(1);
      D_Mag7->maximum(-1);
      D_Mag7->step(0.01);
    ...
    { D_Mag8 = new SliderW(330, 144, 27, 181, gettext("Har.8"));
      ...
      D_Mag8->labelfont(0);
      D_Mag8->labelsize(11);
      D_Mag8->labelcolor(FL_BACKGROUND2_COLOR);
      D_Mag8->minimum(1);
      D_Mag8->maximum(-1);
      D_Mag8->step(0.01);
    ...
    { D_Mag9 = new SliderW(375, 144, 26, 181, gettext("Har.9"));
      ...
      D_Mag9->labelfont(0);
      D_Mag9->labelsize(11);
      D_Mag9->labelcolor(FL_BACKGROUND2_COLOR);
      D_Mag9->minimum(1);
      D_Mag9->maximum(-1);
      D_Mag9->step(0.01);
    ...
    { D_Mag10 = new SliderW(416, 144, 26, 181, gettext("Har.10"));
      ...
      D_Mag10->labelcolor(FL_BACKGROUND2_COLOR);
      D_Mag10->minimum(1);
      D_Mag10->maximum(-1);
      D_Mag10->step(0.01);
