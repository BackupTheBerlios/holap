...
Fl_Double_Window* goomf_ui::make_window() {
  { ui_win = new Fl_Double_Window(500, 580);
    ...
    { Rueda* o = D_Vol = new Rueda(10, 70, 50, 60, gettext("Volume"));
      ...
      D_Vol->selection_color(FL_INACTIVE_COLOR);
      D_Vol->labeltype(FL_NORMAL_LABEL);
      D_Vol->labelfont(0);
      D_Vol->labelsize(11);
      D_Vol->labelcolor(FL_BACKGROUND2_COLOR);
      D_Vol->step(0.01);
      D_Vol->value(1);
    ...
    { Rueda* o = D_Tune = new Rueda(80, 70, 50, 60, gettext("Master Tune"));
      ...
      D_Tune->selection_color(FL_INACTIVE_COLOR);
      D_Tune->labeltype(FL_NORMAL_LABEL);
      D_Tune->labelfont(0);
      D_Tune->labelsize(11);
      D_Tune->labelcolor(FL_BACKGROUND2_COLOR);
      D_Tune->minimum(-1);
      D_Tune->step(0.01);
    ...
    { Rueda* o = D_Portamento = new Rueda(150, 70, 50, 60, gettext("Portamento"));
      ...
      D_Portamento->selection_color(FL_INACTIVE_COLOR);
      D_Portamento->labeltype(FL_NORMAL_LABEL);
      D_Portamento->labelfont(0);
      D_Portamento->labelsize(11);
      D_Portamento->labelcolor(FL_BACKGROUND2_COLOR);
    ...
    { Fl_Group* o = new Fl_Group(10, 285, 480, 210, gettext("Operator Parameters"));
      ...
      { Rueda* o = D_Wave = new Rueda(30, 310, 50, 60, gettext("Wave"));
        ...
        D_Wave->selection_color(FL_INACTIVE_COLOR);
        D_Wave->labeltype(FL_NORMAL_LABEL);
        D_Wave->labelfont(0);
        D_Wave->labelsize(11);
        D_Wave->labelcolor(FL_BACKGROUND2_COLOR);
        D_Wave->minimum(1);
        D_Wave->maximum(9);
        D_Wave->step(1);
        D_Wave->value(1);
      ...
      { Rueda* o = D_H = new Rueda(95, 310, 50, 60, gettext("Harmonic"));
        ...
        D_H->selection_color(FL_INACTIVE_COLOR);
        D_H->labeltype(FL_NORMAL_LABEL);
        D_H->labelfont(0);
        D_H->labelsize(11);
        D_H->labelcolor(FL_BACKGROUND2_COLOR);
        D_H->maximum(21);
        D_H->step(1);
      ...
      { Rueda* o = D_HF = new Rueda(160, 310, 50, 60, gettext("H.Fine"));
        ...
        D_HF->selection_color(FL_INACTIVE_COLOR);
        D_HF->labeltype(FL_NORMAL_LABEL);
        D_HF->labelfont(0);
        D_HF->labelsize(11);
        D_HF->labelcolor(FL_BACKGROUND2_COLOR);
        D_HF->minimum(-0.02);
        D_HF->maximum(0.02);
        D_HF->step(0.0001);
      ...
      { Rueda* o = D_OVol = new Rueda(225, 310, 50, 60, gettext("Volume"));
        ...
        D_OVol->selection_color(FL_INACTIVE_COLOR);
        D_OVol->labeltype(FL_NORMAL_LABEL);
        D_OVol->labelfont(0);
        D_OVol->labelsize(11);
        D_OVol->labelcolor(FL_BACKGROUND2_COLOR);
        D_OVol->step(0.01);
      ...
      { Rueda* o = D_pLFO = new Rueda(290, 310, 50, 60, gettext("pLFO"));
        ...
        D_pLFO->selection_color(FL_INACTIVE_COLOR);
        D_pLFO->labeltype(FL_NORMAL_LABEL);
        D_pLFO->labelfont(0);
        D_pLFO->labelsize(11);
        D_pLFO->labelcolor(FL_BACKGROUND2_COLOR);
        D_pLFO->step(0.01);
      ...
      { Rueda* o = D_Sustain = new Rueda(160, 405, 50, 60, gettext("Sustain"));
        ...
        D_Sustain->labelcolor(FL_BACKGROUND2_COLOR);
        D_Sustain->step(0.01);
        D_Sustain->value(0.5);
      ...
      { Rueda* o = D_Release = new Rueda(225, 405, 50, 60, gettext("Release"));
        ...
        D_Release->selection_color(FL_INACTIVE_COLOR);
        D_Release->labeltype(FL_NORMAL_LABEL);
        D_Release->labelfont(0);
        D_Release->labelsize(11);
        D_Release->labelcolor(FL_BACKGROUND2_COLOR);
    ...
    { LFO = new Fl_Group(225, 50, 265, 100, gettext("LFO"));
      ...
      { Rueda* o = D_LFO_Frequency = new Rueda(305, 70, 50, 60, gettext("Frequency"));
        ...
        D_LFO_Frequency->selection_color(FL_INACTIVE_COLOR);
        D_LFO_Frequency->labeltype(FL_NORMAL_LABEL);
        D_LFO_Frequency->labelfont(0);
        D_LFO_Frequency->labelsize(11);
        D_LFO_Frequency->labelcolor(FL_BACKGROUND2_COLOR);
      ...
      { Rueda* o = D_LFO_Volume = new Rueda(240, 70, 50, 60, gettext("Volume"));
        ...
        D_LFO_Volume->selection_color(FL_INACTIVE_COLOR);
        D_LFO_Volume->labeltype(FL_NORMAL_LABEL);
        D_LFO_Volume->labelfont(0);
        D_LFO_Volume->labelsize(11);
        D_LFO_Volume->labelcolor(FL_BACKGROUND2_COLOR);
      ...
      { Rueda* o = D_LFO_Delay = new Rueda(365, 70, 50, 60, gettext("Delay"));
        ...
        D_LFO_Delay->selection_color(FL_INACTIVE_COLOR);
        D_LFO_Delay->labeltype(FL_NORMAL_LABEL);
        D_LFO_Delay->labelfont(0);
        D_LFO_Delay->labelsize(11);
        D_LFO_Delay->labelcolor(FL_BACKGROUND2_COLOR);
      ...
      { Rueda* o = D_LFO_Wave = new Rueda(425, 70, 50, 60, gettext("Wave"));
        ...
        D_LFO_Wave->selection_color(FL_INACTIVE_COLOR);
        D_LFO_Wave->labeltype(FL_NORMAL_LABEL);
        D_LFO_Wave->labelfont(0);
        D_LFO_Wave->labelsize(11);
        D_LFO_Wave->labelcolor(FL_BACKGROUND2_COLOR);
    ...
    { PresetSelect = new Fl_Counter(20, 550, 60, 25, gettext("Preset"));
      ...
      PresetSelect->selection_color(FL_FOREGROUND_COLOR);
    ...
    { Pname = new Fl_Input(95, 535, 255, 40);
      ...
      Pname->labelfont(1);
      Pname->labelcolor(FL_BACKGROUND2_COLOR);
      Pname->textsize(22);
      Pname->textcolor(5);
    ...
    { Fl_Group* o = new Fl_Group(10, 170, 480, 95, gettext("Filter"));
      ...
      { Rueda* o = D_Ftype = new Rueda(20, 190, 50, 60, gettext("Type"));
        ...
        D_Ftype->selection_color(FL_INACTIVE_COLOR);
        D_Ftype->labeltype(FL_NORMAL_LABEL);
        D_Ftype->labelfont(0);
        D_Ftype->labelsize(11);
        D_Ftype->labelcolor(FL_BACKGROUND2_COLOR);
        D_Ftype->maximum(8);
        D_Ftype->step(1);
      ...
      { Rueda* o = D_Fgain = new Rueda(80, 190, 50, 60, gettext("Gain"));
        ...
        D_Fgain->selection_color(FL_INACTIVE_COLOR);
        D_Fgain->labeltype(FL_NORMAL_LABEL);
        D_Fgain->labelfont(0);
        D_Fgain->labelsize(11);
        D_Fgain->labelcolor(FL_BACKGROUND2_COLOR);
        D_Fgain->step(0.01);
        D_Fgain->value(0.5);
      ...
      { Rueda* o = D_Fcutoff = new Rueda(140, 190, 50, 60, gettext("Cutoff"));
        ...
        D_Fcutoff->selection_color(FL_INACTIVE_COLOR);
        D_Fcutoff->labeltype(FL_NORMAL_LABEL);
        D_Fcutoff->labelfont(0);
        D_Fcutoff->labelsize(11);
        D_Fcutoff->labelcolor(FL_BACKGROUND2_COLOR);
      ...
      { Rueda* o = D_Fq = new Rueda(200, 190, 50, 60, gettext("Resonance"));
        ...
        D_Fq->selection_color(FL_INACTIVE_COLOR);
        D_Fq->labeltype(FL_NORMAL_LABEL);
        D_Fq->labelfont(0);
        D_Fq->labelsize(11);
        D_Fq->labelcolor(FL_BACKGROUND2_COLOR);
        D_Fq->minimum(-1);
        D_Fq->step(0.01);
      ...
      { Rueda* o = D_FLFO = new Rueda(260, 190, 50, 60, gettext("LFO"));
        ...
        D_FLFO->selection_color(FL_INACTIVE_COLOR);
        D_FLFO->labeltype(FL_NORMAL_LABEL);
        D_FLFO->labelfont(0);
        D_FLFO->labelsize(11);
        D_FLFO->labelcolor(FL_BACKGROUND2_COLOR);
        D_FLFO->step(0.01);
      ...
      { Rueda* o = D_FADSR = new Rueda(320, 190, 50, 60, gettext("ADSR"));
        ...
        D_FADSR->selection_color(FL_INACTIVE_COLOR);
        D_FADSR->labeltype(FL_NORMAL_LABEL);
        D_FADSR->labelfont(0);
        D_FADSR->labelsize(11);
        D_FADSR->labelcolor(FL_BACKGROUND2_COLOR);
        D_FADSR->maximum(6);
        D_FADSR->step(1);
      ...
      { Rueda* o = D_Fstages = new Rueda(380, 190, 50, 60, gettext("Stages"));
        ...
        D_Fstages->selection_color(FL_INACTIVE_COLOR);
        D_Fstages->labeltype(FL_NORMAL_LABEL);
        D_Fstages->labelfont(0);
        D_Fstages->labelsize(11);
        D_Fstages->labelcolor(FL_BACKGROUND2_COLOR);
        D_Fstages->minimum(1);
        D_Fstages->maximum(5);
        D_Fstages->step(1);
        D_Fstages->value(1);
